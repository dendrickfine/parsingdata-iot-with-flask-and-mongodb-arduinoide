...
try:
    ...
    db = client.arsenal  # Database name
    collection = db.sensorsdata  # Collection name
...
def get_data():
    try:
        ...
        data = list(collection.find({}, {"_id": 1, "suhumax": 7, "suhumin": 4, "suhurata2": 4, "nilaisuhuhumid": 1, "month_year": 1}))
