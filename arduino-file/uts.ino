...
const char* pub_lampu = "dedrickslamp";
const char* pub_relay = "dedricksrelay";
const char* pub_buzzer = "dedricksbuzzer";
const char* sub_suhu = "dedrickstemperature";
const char* sub_humi = "dedrickshumidity";
const char* sub_turbidity = "dedricksturbidity";
const char* sub_ph = "dedricksph";
